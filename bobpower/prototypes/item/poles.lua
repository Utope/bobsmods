if settings.startup["bobmods-power-poles"].value == true then
  data.raw.item["medium-electric-pole"].order = "a[energy]-b[bob-medium-electric-pole-1]"
  data.raw.item["big-electric-pole"].order = "a[energy]-c[bob-big-electric-pole-1]"
  data.raw.item["substation"].order = "a[energy]-d[bob-substation-1]"
  ...
  data:extend({
    {
      ...
      order = "a[energy]-b[bob-medium-electric-pole-2]",
...

    {
      ...
      icon_size = 64,
      subgroup = "energy-pipe-distribution",
      order = "a[energy]-b[bob-medium-electric-pole-3]",
...

    {
      ...
      icon_size = 64,
      subgroup = "energy-pipe-distribution",
      order = "a[energy]-b[bob-medium-electric-pole-4]",
...

    {
      ...
      icon_size = 64,
      subgroup = "energy-pipe-distribution",
      order = "a[energy]-c[bob-big-electric-pole-2]",
...

    {
      ...
      icon_size = 64,
      subgroup = "energy-pipe-distribution",
      order = "a[energy]-c[bob-big-electric-pole-3]",
...

    {
      ...
      icon_size = 64,
      subgroup = "energy-pipe-distribution",
      order = "a[energy]-c[bob-big-electric-pole-4]",
...

    {
      ...
      icon_size = 64,
      subgroup = "energy-pipe-distribution",
      order = "a[energy]-d[bob-substation-2]",
...

    {
      ...
      icon_size = 64,
      subgroup = "energy-pipe-distribution",
      order = "a[energy]-d[bob-substation-3]",
...

    {
      ...
      icon_size = 64,
      subgroup = "energy-pipe-distribution",
      order = "a[energy]-d[bob-substation-4]",
