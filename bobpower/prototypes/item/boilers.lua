if settings.startup["bobmods-power-steam"].value == true then
  data.raw.item["boiler"].order = "b[steam-power]-a[bob-boiler-1]"
  ...
  data:extend({
    {
      ...
      order = "b[steam-power]-a[bob-boiler-2]",
...

    {
      ...
      icon_size = 64,
      subgroup = "bob-energy-boiler",
      order = "b[steam-power]-a[bob-boiler-3]",
...

    {
      ...
      icon_size = 64,
      subgroup = "bob-energy-boiler",
      order = "b[steam-power]-a[bob-boiler-4]",
...

    {
      ...
      icon_size = 64,
      subgroup = "bob-energy-boiler",
      order = "b[steam-power]-a[bob-boiler-5]",
