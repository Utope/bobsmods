if settings.startup["bobmods-power-steam"].value == true then
  data.raw.item["heat-exchanger"].order = "f[nuclear-energy]-b[bob-heat-exchanger-1]"
  ...
  data:extend({
    {
      ...
      order = "f[nuclear-energy]-b[bob-heat-exchanger-2]",
...

    {
      ...
      icon_size = 64,
      subgroup = "bob-energy-heat-exchanger",
      order = "f[nuclear-energy]-b[bob-heat-exchanger-3]",
...

    {
      ...
      icon_size = 64,
      subgroup = "bob-energy-heat-exchanger",
      order = "f[nuclear-energy]-b[bob-heat-exchanger-4]",
