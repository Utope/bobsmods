  ...
  data:extend({
    {
      ...
      order = "b[steam-power]-b[bob-oil-boiler-1]",
...

    {
      ...
      icon = "__bobpower__/graphics/icons/oil-boiler.png",
      subgroup = "bob-energy-oil-boiler",
      order = "b[steam-power]-b[bob-oil-boiler-2]",
...

    {
      ...
      icon = "__bobpower__/graphics/icons/oil-boiler.png",
      subgroup = "bob-energy-oil-boiler",
      order = "b[steam-power]-b[bob-oil-boiler-3]",
...

    {
      ...
      icon = "__bobpower__/graphics/icons/oil-boiler.png",
      subgroup = "bob-energy-oil-boiler",
      order = "b[steam-power]-b[bob-oil-boiler-4]",
