if settings.startup["bobmods-power-poles"].value == true then
  ...
  if data.raw.item["tinned-copper-cable"] then
    bobmods.lib.recipe.replace_ingredient("bob-medium-electric-pole-2", "copper-plate", "tinned-copper-cable")
    bobmods.lib.recipe.replace_ingredient("bob-big-electric-pole-2", "copper-plate", "tinned-copper-cable")
    bobmods.lib.recipe.replace_ingredient("bob-substation-2", "copper-plate", "tinned-copper-cable")
  ...
  if data.raw.item["insulated-cable"] then
    bobmods.lib.recipe.replace_ingredient("bob-medium-electric-pole-3", "copper-plate", "insulated-cable")
    bobmods.lib.recipe.replace_ingredient("bob-big-electric-pole-3", "copper-plate", "insulated-cable")
    bobmods.lib.recipe.replace_ingredient("bob-substation-3", "copper-plate", "insulated-cable")
  ...
  if data.raw.item["gilded-copper-cable"] then
    bobmods.lib.recipe.replace_ingredient("bob-medium-electric-pole-4", "copper-plate", "gilded-copper-cable")
    bobmods.lib.recipe.replace_ingredient("bob-big-electric-pole-4", "copper-plate", "gilded-copper-cable")
    bobmods.lib.recipe.replace_ingredient("bob-substation-4", "copper-plate", "gilded-copper-cable")
