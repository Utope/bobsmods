if settings.startup["bobmods-power-fluidgenerator"].value == true then
  ...
  if data.raw.item["steel-pipe"] then
    bobmods.lib.recipe.replace_ingredient("bob-fluid-generator", "pipe", "steel-pipe")
  end
  ...
  if data.raw.item["brass-pipe"] then
    bobmods.lib.recipe.add_ingredient("bob-fluid-generator-2", { type = "item", name = "brass-pipe", amount = 5 })
    bobmods.lib.tech.add_prerequisite("bob-fluid-generator-2", "bob-zinc-processing")
  elseif data.raw.item["steel-pipe"] then
    bobmods.lib.recipe.add_ingredient("bob-fluid-generator-2", { type = "item", name = "steel-pipe", amount = 5 })
  end
  ...
  if data.raw.item["ceramic-pipe"] then
    bobmods.lib.recipe.add_ingredient("bob-fluid-generator-3", { type = "item", name = "ceramic-pipe", amount = 5 })
