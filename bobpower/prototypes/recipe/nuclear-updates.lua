if settings.startup["bobmods-power-nuclear"].value == true then
  ...
  if data.raw.item["heat-pipe-3"] then
    ...
    bobmods.lib.recipe.add_ingredient("bob-nuclear-reactor-2", { type = "item", name = "heat-pipe-3", amount = 25 })
  ...
  if data.raw.item["heat-pipe-4"] then
    ...
    bobmods.lib.recipe.add_ingredient("bob-nuclear-reactor-3", { type = "item", name = "heat-pipe-4", amount = 25 })
