if settings.startup["bobmods-power-steam"].value == true then
  if data.raw.item["steel-pipe"] then
    bobmods.lib.recipe.add_ingredient("bob-boiler-2", { type = "item", name = "steel-pipe", amount = 4 })
  end
  ...
  if data.raw.item["brass-pipe"] then
    bobmods.lib.recipe.add_ingredient("bob-boiler-3", { type = "item", name = "brass-pipe", amount = 4 })
  ...
  if data.raw.item["ceramic-pipe"] then
    bobmods.lib.recipe.add_ingredient("bob-boiler-4", { type = "item", name = "ceramic-pipe", amount = 4 })
  ...
  if data.raw.item["copper-tungsten-pipe"] then
    bobmods.lib.recipe.add_ingredient("bob-boiler-5", { type = "item", name = "copper-tungsten-pipe", amount = 4 })
  elseif data.raw.item["tungsten-pipe"] then
    bobmods.lib.recipe.add_ingredient("bob-boiler-5", { type = "item", name = "tungsten-pipe", amount = 4 })
  end
end
